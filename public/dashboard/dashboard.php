                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card bg-success text-white shadow">
                            <div class="card-body">
                                <span class="text-white-50">Welcome!</span>

                                <?php if (isset($_SESSION['isLoggedIn'])) :?> 
                                <div class="text-white-65 small"><?= $_SESSION['firstname']?></div>
                                <?php endif?>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
            <div class="copyright text-center my-auto">
                <span>Copyright &copy; Market Place <?= date('Y')?> Made with &#10084; by <a href="https://twitter.com/@varsilias">Daniel Okoronkwo</a></span>
            </div>
        </div>
    </footer>
    <!-- End of Footer -->
