<?php
    ...
    if (!isset($_SESSION['isLoggedIn'])) {
        ...
        $products = new ProductRequest();
        $results = $products->getAllProducts($_SESSION['id']);
    }
...
<head>
    ...
    <title>Products | Market Place</title>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="d-flex justify-content-between">
                                <!-- <h6 class="m-0 font-weight-bold text-primary float">All products</h6> -->

                                <a class="btn btn-success" href="add-product.php">
                                    <i class="fas fa-plus fa-fw mr-2 text-gray-200"></i>
                                    Add product
                                </a>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <?php if (count($results) > 0):?>
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($results as $key => $product):?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit-product.php?id=<?= $product["id"]?>" class="text-primary">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="delete-product.php?id=<?= $product["id"]?>" class="text-danger">
                                ...
                                <?php else: ?>
                                    <h5 class="text-dark">No Product(s) added yet</h5>
                            <?php endif ?>
